 ...
 * @Description:
 * @Date: Created in 2017/12/1, 15:22
 * @Modified By:
 * @Email: franciszhuge@163.com
 */
public class EnergyConsumptionDo implements Comparable<EnergyConsumptionDo>{
    //电压      uan
    ...
    @Override
    public int compareTo(EnergyConsumptionDo o) {
        return TimeUtil.isLater(o.getTime(),this.getTime());
    }
    ...
    public static void main(String[] args) {
        List<EnergyConsumptionDo> energyConsumptionDos = new ArrayList<>();
        EnergyConsumptionDo energyConsumptionDo = new EnergyConsumptionDo();
        energyConsumptionDo.setTime("2017-10-11 16:38:21");
        energyConsumptionDos.add(energyConsumptionDo);

        EnergyConsumptionDo energyConsumptionDo1 = new EnergyConsumptionDo();
        energyConsumptionDo1.setTime("2017-10-12 16:39:23");
        energyConsumptionDos.add(energyConsumptionDo1);

        EnergyConsumptionDo energyConsumptionDo3 = new EnergyConsumptionDo();
        energyConsumptionDo3.setTime("2017-10-10 16:36:23");
        energyConsumptionDos.add(energyConsumptionDo3);

        Collections.sort(energyConsumptionDos);
        for (EnergyConsumptionDo energyConsumptionDo2:energyConsumptionDos){
            System.out.println(energyConsumptionDo2);
        }
        System.out.println(energyConsumptionDos.get(0));
    }
}
